...
export default function Home() {
 ...
 setPreviewError('Video preview failed. You can still try Download.');
 }}
 />
 ...
 setIsPlaying(false);
 setShowCenterControl(true);
 if (item.type !== 'audio') setIsVideoLoading(true);
 }}
 >
 {item.type === 'audio' ? (
 <>
 <i className="bi bi-music-note me-1"></i>
 {item.ext ? item.ext.toUpperCase() : 'MP3'}
 {item.quality ? ` • ${item.quality}` : ''}
 </>
 ) : (
 <>
 <i className="bi bi-camera-video me-1"></i>
 {item.ext ? item.ext.toUpperCase() : 'MP4'}
 {item.quality ? ` • ${item.quality}` : ''}
 </>
 )}
 </button>
 ...
 <div className="card h-100 text-center border-0 shadow-sm">
 <div className="card-body">
 <div className="display-4 mb-3">4</div>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">Web-Based App – No Installation Required</h5>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">AI-Enhanced Quality Optimization</h5>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">Built-In Video Player Preview</h5>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">Fast & Secure Download Process</h5>
 <p className="card-text">The entire process is secure and private. Links are processed instantly, and files are delivered quickly to your device without unnecessary delays. They are processed temporarily and deleted after download to protect user privacy.</p>
 </div>
 </div>
 </div>
 <div className="col-lg-4 col-md-6">
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">Works on All Devices & Browsers</h5>
 ...
 <div className="card h-100 border-0 shadow-sm">
 <div className="card-body">
 <h5 className="card-title mb-3">Desktop (Windows & Mac)</h5>
 ...
 <div className="card h-100 border-0 shadow-sm">
 <div className="card-body">
 <h5 className="card-title mb-3">Google Drive Storage</h5>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">No Hidden Pricing Plan</h5>
 ...
 <div className="card h-100 border-0 shadow-sm text-center">
 <div className="card-body">
 <h5 className="card-title mb-3">Optimized for Social Media Content Creators</h5>
